...
class Face_recognition_System:
    def __init__(self,root):  
        ...
        #Third Image
        img2=Image.open(r"college_images\js.png")
        ...
        # student button
        img4=Image.open(r"college_images\search.png")
        ...
        img5=Image.open(r"college_images\download.jpg")
        ...
        img6=Image.open(r"college_images\search.png")
        ...
        # Train data button
        img8=Image.open(r"college_images\table.png")
        ...
        # Photos face button
        img9=Image.open(r"college_images\memories.png")
